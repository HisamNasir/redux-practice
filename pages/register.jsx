...
return (
  <div className="flex min-w-max flex-col h-screen justify-center items-center">
      ...
      >
        ...
        {loading ? (
            <div className="text-sky-500 text-lg text-center gap-2 flex w-full justify-center text-center items-center"><span className=" flex justify-center items-center animate-spin"><FaSpinner/></span> <p>Loading...</p></div>
          ) : (
            <div>
              <button
