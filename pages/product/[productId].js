  ...
  return (
    <Layout>
        <div className="bg-gray-100 space-y-2 rounded-lg dark:bg-gray-900 p-4">
          <h1 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">Product Detail</h1>
    ...
    <h2 className=" text-xl font-semibold">{product.title}</h2>
      <p className=" text-md font-semibold">Category: <span className=' text-sky-500'>{product.category}</span></p>
